...
public class UIManager : MonoBehaviour, ITimeTracker
{
    ...
    bool pressInventoryOnKey = false;
    bool pressInventoryOffKey = true;
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.B) == true && inventoryState == false && pressInventoryOnKey == false && pressInventoryOffKey == true)
        {
            ...
            Cursor.visible = true;
            inventoryState = true;
            pressInventoryOnKey = true;
        }
        if (Input.GetKeyDown(KeyCode.B) == true && inventoryState == true && pressInventoryOnKey == true && pressInventoryOffKey == false)
        {
            inventoryLogo.SetActive(true);
            inventoryPanel.SetActive(false);
            ...
            inventoryState = false;
            pressInventoryOffKey = true;
        }
        if (Input.GetKeyUp(KeyCode.B) == true)
        {
            if (pressInventoryOnKey == true && inventoryState == true)
            {
                pressInventoryOffKey = false;
            }
            if (pressInventoryOffKey == true && inventoryState == false)
            {
                pressInventoryOnKey = false;
            }
        }
